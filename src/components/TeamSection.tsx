          ...
          {team.map((member) => (
            ...
            >
              <div className="bg-card rounded-2xl p-6 border border-border/50 hover:border-amber/30 transition-all duration-300 hover:shadow-lg h-full flex flex-col">
                {/* Avatar */}
                <div className="aspect-square w-full max-w-[140px] mx-auto mb-5 rounded-2xl bg-gradient-to-br from-secondary to-warm-gray-light flex items-center justify-center border-2 border-border group-hover:border-amber/30 transition-colors overflow-hidden relative">
                  {member.image ? (
                    <img
                      src={member.image}
                      alt={member.name}
          ...
          <DialogContent className="sm:max-w-lg bg-card border-border/50">
            <DialogHeader className="text-left">
              <div className="flex items-start gap-4 mb-2">
                {/* Avatar in Modal */}
                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-secondary to-warm-gray-light flex items-center justify-center border border-border flex-shrink-0 overflow-hidden relative">
